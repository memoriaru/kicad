...
pub fn compute_dip_outlines(
    ...
    lines.push(OutlineLine {
        ...
        x2: cex,
        y2: cy_top,
        layer: OutlineLayer::CrtYd,
        width: CRTYD_LINE_WIDTH,
    });
    lines.push(OutlineLine {
        x1: cx,
        y1: cy_bot,
...
/// Compute outlines for an SMD package
...
fn rect_lines(hw: f64, hh: f64, layer: OutlineLayer, width: f64) -> Vec<OutlineLine> {
    vec![
        OutlineLine {
            x1: -hw,
            y1: -hh,
