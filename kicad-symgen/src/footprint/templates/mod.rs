...
pub fn generate_from_spec(spec: &FootprintSpec) -> Option<TemplateResult> {
    match spec.package_type {
        PackageType::Dip | PackageType::Sip | PackageType::DipSocket => dip::generate_dip(spec),
        ...
        | PackageType::Sot89
        | PackageType::Sot353
        | PackageType::Sot363 => sot::generate_sot(spec),
        PackageType::Qfp | PackageType::Lqfp | PackageType::Tqfp => qfp::generate_qfp(spec),
        PackageType::Qfn | PackageType::Dfn => qfn::generate_qfn(spec),
        PackageType::Bga => bga::generate_bga(spec),
        _ => None,
    }
}
