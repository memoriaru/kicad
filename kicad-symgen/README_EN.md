...
Works with the [kicad-cdb](https://github.com/memoriaru/kicad/tree/main/kicad-cdb) component database, or accepts JSON5 input independently.
...
| Tool | Function |
|------|----------|
| [kicad-cdb](https://github.com/memoriaru/kicad/tree/main/kicad-cdb) | Component database (SQLite), stores MPN/pin/parameters |
| **kicad-symgen** | Generate symbol and footprint files from DB/JSON5 |
| [kicad-json5](https://github.com/memoriaru/kicad/tree/main/kicad-json5) | Bidirectional .kicad_sch ↔ JSON5 compiler |
