...
与 [kicad-cdb](https://github.com/memoriaru/kicad/tree/main/kicad-cdb) 元件数据库配合使用，也可独立接受 JSON5 输入。
...
| 工具 | 功能 |
|------|------|
| [kicad-cdb](https://github.com/memoriaru/kicad/tree/main/kicad-cdb) | 元件数据库 (SQLite)，存储 MPN/pin/参数 |
| **kicad-symgen** | 从 DB/JSON5 生成符号和封装文件 |
| [kicad-json5](https://github.com/memoriaru/kicad/tree/main/kicad-json5) | .kicad_sch ↔ JSON5 双向编译 |
