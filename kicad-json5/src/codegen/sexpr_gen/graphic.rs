...
impl SexprGenerator {
    ...
    pub(super) fn generate_graphic_element(
        &mut self,
        output: &mut String,
    ...
    fn generate_rectangle(&mut self, output: &mut String, rect: &Rectangle) {
        ...
        self.write_line(
            ...
            &format!(
                "(start {} {})",
                Self::format_number(rect.start.0),
                Self::format_number(rect.start.1)
            ),
        );
        self.write_line(
            output,
            &format!(
                "(end {} {})",
                Self::format_number(rect.end.0),
                Self::format_number(rect.end.1)
            ),
        );
    ...
    fn generate_circle(&mut self, output: &mut String, circle: &Circle) {
        ...
        self.write_line(
            ...
            &format!(
                "(center {} {})",
                Self::format_number(circle.center.0),
                Self::format_number(circle.center.1)
            ),
        );
        self.write_line(
            output,
            &format!("(radius {})", Self::format_number(circle.radius)),
        );
    ...
    fn generate_arc(&mut self, output: &mut String, arc: &Arc) {
        ...
        self.write_line(
            ...
            &format!(
                "(start {} {})",
                Self::format_number(arc.start.0),
                Self::format_number(arc.start.1)
            ),
        );
        self.write_line(
            output,
            &format!(
                "(mid {} {})",
                Self::format_number(arc.mid.0),
                Self::format_number(arc.mid.1)
            ),
        );
        self.write_line(
            output,
            &format!(
                "(end {} {})",
                Self::format_number(arc.end.0),
                Self::format_number(arc.end.1)
            ),
        );
    ...
    fn generate_text(&mut self, output: &mut String, text: &Text) {
        ...
        self.write_line(
            output,
            &Self::format_at(text.position.0, text.position.1, text.position.2),
        );
