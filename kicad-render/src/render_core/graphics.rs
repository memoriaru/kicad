...
use super::{BoundingBox, Color, Matrix, Point};
...
impl StrokeStyle {
    ...
    pub fn to_svg_dash_array(&self, width: f64) -> Option<String> {
        match self {
            ...
            StrokeStyle::DashDotDot => Some(format!(
                "{} {} {} {} {} {}",
                width * 4.0,
                width,
                width,
...
impl Rectangle {
    ...
    /// Get bounding box
    pub fn bbox(&self) -> BoundingBox {
        BoundingBox::from_min_max(self.x, self.y, self.x + self.width, self.y + self.height)
    }
}
...
mod tests {
    ...
    fn test_polygon_closed() {
        let closed = Polygon::from_points(&[
            (0.0, 0.0),
            (10.0, 0.0),
            (10.0, 10.0),
            (0.0, 10.0),
